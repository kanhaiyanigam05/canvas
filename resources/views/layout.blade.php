...
<head>
    ...
    @if (\Kanhaiyanigam05\Canvas::enabledDarkMode($jsVars['user']['dark_mode']))
        <link rel="stylesheet"
            href="//cdn.jsdelivr.net/gh/highlightjs/cdn-release@11.8.0/build/styles/sunburst.min.css">
    @else
...
<body class="mb-5" @if (\Kanhaiyanigam05\Canvas::enabledDarkMode($jsVars['user']['dark_mode'])) data-theme="dark" @endif
    @if (\Kanhaiyanigam05\Canvas::usingRightToLeftLanguage($jsVars['user']['locale'])) data-lang="rtl" @endif>

    @if (!\Kanhaiyanigam05\Canvas::assetsUpToDate())
